...
--------------------------------------------------------------------------------------
-- add endpoint
INSERT INTO CONN_ENDPOINT (ENDPOINT_ID,SCHEME,HOSTNAME,PORT,PATH,DESCRIPTION) VALUES ('ConnBhubHttp', 'https', 'bhubint01.cz.dev.intapp.eu', 6800, '','Endpoint for BHUB');
INSERT INTO CONN_ENDPOINT (ENDPOINT_ID,SCHEME,HOSTNAME,PORT,PATH,DESCRIPTION) VALUES ('ConnBhubHttp2', 'https', 'bhubint01.cz.dev.intapp.eu', 6900, '','Endpoint for BHUB2');
